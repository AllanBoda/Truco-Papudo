...
class _BoardPageState extends State<BoardPage> {
  final Game game =
      Game(); // Instância da classe Game para gerenciar a lógica do jogo
  int jogadoresQueJogaram =
      0; // Variável de controle para acompanhar quantos jogadores jogaram suas cartas
  ...
  void _jogarCarta(int index, Jogador jogador) {
    setState(() {
      if (cartaTocada &&
          jogadoresQueJogaram <= 4 &&
          jogador == game.jogadorAtual) {
        // Verifica se a carta foi tocada, se ainda não foram jogadas as cartas de todos os jogadores e se é a vez do jogador
        game.escolherCartaDaJogada(index,
            jogador); // Chama o método escolherCartaDaJogada da classe Game passando o índice clicado
        ...
        if (jogadoresQueJogaram == 4) {
          ...
          jogadoresQueJogaram =
              0; // Reinicia o contador de jogadores que jogaram
        }
      }
    });
  }
  ...
  List<CardModel> converterCartasNaMesaParaString(
      List<CartaNaMesa> cartasNaMesa) {
    return cartasNaMesa.map((cartaNaMesa) {
      return CardModel(
          faceValue:
              '${cartaNaMesa.carta?.valor} de ${cartaNaMesa.carta?.naipe}',
          ...
          children: [
            ...
            Expanded(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  // Mão do jogador 1 - Jessica (em cima)
                  PlayerHand(
                    ...
                    isCurrentPlayer: game.baralho.listaJogador[0] ==
                        game.jogadorAtual, // Adiciona o indicador
                    playerName: game.baralho.listaJogador[0].nome,
                    playerTeam: game.baralho.listaJogador[0].equipe,
                  ),
                  // Jogadores 2 (Natan - esquerda) e 3 (Gabriel - direita)
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      PlayerHand(
                        ...
                        isCurrentPlayer: game.baralho.listaJogador[1] ==
                            game.jogadorAtual, // Adiciona o indicador
                      ...
                      Wrap(
                        ...
                        children: converterCartasNaMesaParaString(
                                game.baralho.cartasNaMesa)
                            .map((cardModel) {
                          return TrucoCard(
                            cardModel: cardModel,
                      ...
                      PlayerHand(
                        ...
                        isCurrentPlayer: game.baralho.listaJogador[3] ==
                            game.jogadorAtual, // Adiciona o indicador
                  ...
                  // Mão do jogador 4 - Emily (embaixo)
                  PlayerHand(
                    hand: converterCartasParaString(
                    ...
                    isCurrentPlayer: game.baralho.listaJogador[2] ==
                        game.jogadorAtual, // Adiciona o indicador
